...
const Hero = () => {
    return (
        <section className="relative overflow-hidden py-8 sm:py-12 md:py-20 lg:py-28 flex items-center">
            <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10 grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-14 items-center">
                ...
                <div className="space-y-6 sm:space-y-8 md:space-y-10 text-center lg:text-left animate-fade-in-up">
                    ...
                    <div className="flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-4 mt-6 sm:mt-8">
                        ...
                        <Link
                            href="/lyceum/modules"
                            className="flex items-center gap-2 sm:gap-3 bg-black px-6 sm:px-8 h-10 sm:h-12 rounded-xl sm:rounded-2xl backdrop-blur-md border border-purple-300/60 shadow-lg shadow-purple-300/40 transition-all duration-300 transform hover:scale-[1.03]"
                        >
