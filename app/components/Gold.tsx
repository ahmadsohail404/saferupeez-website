...
export function Gold() {
  ...
  // User-chosen expected annual return (%)
  const [expectedReturn, setExpectedReturn] = useState(10.6); // default ~long-term avg

  // Use chosen % instead of fixed 11
  const rate = expectedReturn / 100;
  const estimatedReturns = Math.round(savedAmount * rate * years[0]);
      ...
      <div className="w-full max-w-[1100px] px-4">
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <Badge className="font-bold  text-green-600 text-sm px-4 py-1 bg-green-50">
            ...
            {[
              ...
              >
                ...
                <p className="text-amber-700 text-xs">
                  {item.karat} Gold / 10gm
                </p>

                <p className="text-[#2e1a47] font-bold text-2xl md:text-3xl">
                  {item.price}
                </p>
              </Card>
            ))}
          ...
          <div className="space-y-6">
            <Card className="bg-linear-to-br from-yellow-150 to-yellow-200 text-black p-6 rounded-2xl min-h-[200px] shadow-lg">
              ...
              <h4 className="text-center text-lg font-semibold">
                Get alerts when Gold prices drop
              </h4>
            ...
            <div className="space-y-6">
              ...
              <Card className="p-4 bg-yellow-50 rounded-xl">
                <div className="flex justify-between mb-2 text-sm">
                  ...
                  <span className="text-black-700 font-bold text-lg">
                    ₹{dailyAmount[0]}
                  </span>
                </div>
              ...
              <div className="space-y-1">
                ...
                <Select
                  ...
                  onValueChange={(v) => setExpectedReturn(parseFloat(v))}
                >
                  <SelectTrigger className="h-9 w-full text-s">
                    <SelectValue placeholder="Choose return %" />
                  </SelectTrigger>

                  <SelectContent className="text-s" align="end">
                    {/* You can tweak these values anytime when you update your content */}
                    <SelectItem value="10.6">Long-term avg (~10.6%)</SelectItem>
                    <SelectItem value="13.6">Last 10 years (~13.6%)</SelectItem>
                    <SelectItem value="13">Last 5 years (~13%)</SelectItem>
                    <SelectItem value="24">Last 3 years (~24%)</SelectItem>
                    <SelectItem value="40">Last year (~40%)</SelectItem>
                  </SelectContent>
                </Select>

                <p className="text-[12px] text-black">
                  Based on historical gold performance. Actual returns may vary.
                </p>
              </div>
