        ...
        {[...reviews, ...reviews].map((item, i) => (
          ...
          >
            ...
            <div className="mb-2 relative">
              <div className="absolute -top-2 -left-2 w-8 h-8 bg-gradient-to-br from-amber-400 to-yellow-500 rounded-xl opacity-20 transform rotate-6" />
              <Quote className="relative w-6 h-6 text-amber-600" />
            </div>

            {/* Review Text */}
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed mb-4 min-h-[72px] sm:min-h-[88px] break-words">
              {item.text}
            </p>
            ...
            <div className="flex items-center gap-3">
              <div className="relative w-10 h-10 flex-shrink-0">
                <div className="absolute inset-0 bg-gradient-to-br from-amber-400 to-yellow-500 rounded-full transform rotate-6 group-hover:rotate-12 transition-transform duration-500" />
                <img
                  src={item.avatar}
                  alt={item.name}
...
export default function ReviewsSection() {
  return (
    <section className="relative py-16 sm:py-20 md:py-24 bg-gradient-to-br from-amber-50 via-white to-yellow-50/40 overflow-hidden">
      ...
      {/* CENTERED CONTAINER (same pattern as other sections) */}
